...
export b64_creator=`echo $CREATOR_ACCT | base64 -w0`
...
$GCMD app update --app-id 26 --approval-prog $APP_NAME --clear-prog $CLEAR_NAME -f $PLATFORM_ACCT
